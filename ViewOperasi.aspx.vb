...
Partial Class ViewOperasi
    ...
    Protected Sub CmdPreview_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles CmdPreview.Click
        ...
        strsql = "SELECT  aa.vc_no_trans, convert(varchar(10),dt_tgl_operasi,101) as dt_tgl_operasi, convert(varchar(5),dt_tgl_operasi,108) as dt_jam_operasi, aa.vc_no_rm,aa.vc_no_reg, vc_nama_p, " & _
                 ...
                 "WHERE	convert(varchar(10),dt_tgl_operasi,120) Between CONVERT(DATETIME,'" & MasterLib.xDate(DateTglDari.Text) & "') and CONVERT(DATETIME,'" & MasterLib.xDate(DateTglSampai.Text) & "')  AND    aa.vc_status = '2'  " & _
                 ...
                 "WHERE	convert(varchar(10),dt_tgl_operasi,120) Between CONVERT(DATETIME,'" & MasterLib.xDate(Me.DateTglDari.Text) & "') and CONVERT(DATETIME,'" & MasterLib.xDate(DateTglDari.Text) & "')  AND    aa.vc_status = '2'  " & _
                 "AND BT_OPERASI = 1 " & _
                 "ORDER BY vc_nama_kry "
