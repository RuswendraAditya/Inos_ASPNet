<%@ Page Language="VB"   MasterPageFile="~/MasterPageBlank.master" AutoEventWireup="false" CodeFile="FormMonitoringVAP.aspx.vb" Inherits="FormMonitoringVAP" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width: 632px; height: 200px;" border="1" >
     <tr>
            ...
            <td colspan="5" style="font-weight: bold; font-size: 11pt; color: blue; height: 25px; width: 150px; text-align: center;">
                ...
                PELAKSAAAN BUNDLE PENCEGAHAN VAP</td>
        </tr>
        <tr>
         ...
         CssClass="mGrid" Height="30px" ShowFooter="True" Width="150px" Font-Size="8pt" Font-Italic="True" >  
            <Columns>  
              ...
              <asp:TemplateField HeaderText="VC kode" visible ="false" >  
                ...
                <asp:TemplateField HeaderText="Pencegahan VAP" >  
                    <ItemTemplate >  
    ...
    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CellPadding="1"    datakeynames="in_monitoring_hdr_id,vc_kode"
         CssClass="mGrid" Height="30px" ShowFooter="True" Width="150px" Font-Size="8pt" Font-Italic="True" >  
            <Columns>   
             <asp:TemplateField HeaderText="Monitoring" visible="false">  
                    <ItemTemplate>  
                        <asp:Label ID="lbl_id_diag" runat="server"  Enabled ="false"  Text='<%# Eval("in_monitoring_hdr_id") %>'></asp:Label>  
                    </ItemTemplate>  
                </asp:TemplateField>  
              <asp:TemplateField HeaderText="VC kode"  visible="false">  
                    <ItemTemplate>  
                        <asp:Label ID="lbl_kode_diag" runat="server" Enabled ="false"  Text='<%# Eval("vc_kode") %>'></asp:Label>  
                    </ItemTemplate>  
                </asp:TemplateField>  
                <asp:TemplateField HeaderText="Diagnosa VAP">  
                    <ItemTemplate>  
                        <asp:Label ID="lbl_nama" runat="server" Width="150px"   Text='<%# Eval("vc_nama") %>'></asp:Label>  
                    </ItemTemplate>  
                </asp:TemplateField>  
    ...
    <br />
    <br />
    <table style="width: 584px; height: 88px;" border="1" >
        <tr>
            <td style="width: 25px; height: 16px;">
                Kejadian Infeksi Rumah Sakit(VAP)</td>
            <td style="width: 341px; height: 16px;"><asp:CheckBox ID="ChkBoxInfeksiVAPYa" runat="server" Text="Ya" TextAlign="Left" />
                <asp:CheckBox ID="ChkBoxInfeksiVAPTidak" runat="server" Text="Tidak" TextAlign="Left" /></td>
        </tr>
    </table>
                <br /><br />
               <div align="center">
         <asp:Button ID="BtnSaveMonitoringVAP"   runat="server" Text="Save" Height="48px" Width="128px" BackColor="CornflowerBlue" />
