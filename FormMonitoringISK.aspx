<%@ Page Language="VB"   MasterPageFile="~/MasterPageBlank.master" AutoEventWireup="false" CodeFile="FormMonitoringISK.aspx.vb" Inherits="FormMonitoringISK" %>
    ...
    <table style="width: 732px; height: 300px;" border="1" >
     <tr>
            ...
            <td colspan="5" style="font-weight: bold; font-size: 11pt; color: blue; height: 55px; width: 312px; text-align: center;">
                FORMULIR MONITORING PELAKSAAAN BUNDLE PENCEGAHAN ISK</td>
        </tr>
        <tr>
            <td style="width: 26px; height: 20px;">
                Jenis Cateter</td>
            <td style="width: 341px; height: 20px"><asp:CheckBox ID="chkBoxSilikon" runat="server" Text="Silikon" TextAlign="Left" />
                <br />
                <asp:CheckBox ID="chkBoxFolley" runat="server" Text="Folley" TextAlign="Left" />
                <br />
            </td>
        </tr>
        <tr>
            <td style="width: 26px; height: 29px;">
                No Cateter</td>
            <td style="width: 341px; height: 29px;"><asp:CheckBox ID="chkBoxCateter10" runat="server" Text="10" TextAlign="Left" /><br />
                <asp:CheckBox ID="chkBoxCateter12" runat="server" Text="12" TextAlign="Left" /><br />
                <asp:CheckBox ID="chkBoxCateter14" runat="server" Text="14" TextAlign="Left" /><br />
         ...
         CssClass="mGrid" Height="30px" ShowFooter="True" Width="150px" Font-Size="8pt" Font-Italic="True" >  
            <Columns>  
              ...
              <asp:TemplateField HeaderText="VC kode" visible =false >  
                ...
                <asp:TemplateField HeaderText="Pencegahan ISK" >  
                    <ItemTemplate >  
    ...
    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CellPadding="1"    datakeynames="in_monitoring_hdr_id,vc_kode"
         CssClass="mGrid" Height="30px" ShowFooter="True" Width="150px" Font-Size="8pt" Font-Italic="True" >  
            <Columns>   
             <asp:TemplateField HeaderText="Monitoring" visible=false>  
              ...
              <asp:TemplateField HeaderText="VC kode" visible=false>  
                ...
                <asp:TemplateField HeaderText="Diagnosa ISK">  
                    <ItemTemplate>  
                        <asp:Label ID="lbl_nama" runat="server" Width="150px"   Text='<%# Eval("vc_nama") %>'></asp:Label>  
                    </ItemTemplate>  
                </asp:TemplateField>  
            ...
            <RowStyle BackColor="#ffffff"/>  
                ...
                <br /><table style="width: 700px; height: 100px;" border="1" >
                    <tr>
            <td style="width: 26px; height: 19px;">
                Kejadian Infeksi Rumah Sakit(ISK)</td>
            <td style="width: 341px; height: 19px;"><asp:CheckBox ID="ChkBoxInfeksiISKYa" runat="server" Text="Ya" TextAlign="Left" />
                <asp:CheckBox ID="ChkBoxInfeksiISKTidak" runat="server" Text="Tidak" TextAlign="Left" /></td>
                    </tr>
                </table>
    <br />
               <div align="center">
         <asp:Button ID="BtnSaveMonitoringISK"   runat="server" Text="Save" Height="48px" Width="128px" BackColor="CornflowerBlue" />
