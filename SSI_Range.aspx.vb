...
Partial Class SSI_Range
    ...
    Private Sub LapHais()
        ...
        dthasil.Columns.Add("SSI")                              'Ambil NAMA surveilans
        ...
        strsql = "SELECT INOS_Master_SSI.vc_kode, Inos_Master_Target.vc_nama_surveilans, Inos_Master_Target.dc_target " & _
                 "from INOS_Master_SSI inner join Inos_Master_Target " & _
                 "on INOS_Master_SSI.vc_kode = Inos_Master_Target.vc_kode " & _
                 "order by vc_kode"
        ...
        If Request.QueryString("pTriwulan") = 2 Then
            ...
            Else
                strsql = "SELECT IN_BULAN, IN_TAHUN, isnull(dc_IADP_hasil,0) as dc_IADP_hasil, isnull(in_lama_IADP,0) as in_lama_IADP, " & _
                         ...
                         "VC_K_RUANG = '" & Request.QueryString("kRuang") & "' "
        ...
        While objdatareader.Read
            For j = 0 To dthasil.Rows.Count - 1
                If dthasil.Rows(j).Item("kode") = "0004" Then    'bersih
                    'jika bulan 1,4,7,10 
                    If objdatareader("in_bulan") = 1 Or objdatareader("in_bulan") = 4 Or objdatareader("in_bulan") = 7 Or objdatareader("in_bulan") = 10 Then
                        dthasil.Rows(j).Item("lama1") = objdatareader("in_lama_bersih")
                        dthasil.Rows(j).Item("JUMLAH1") = Val(dthasil.Rows(j).Item("JUMLAH1")) + objdatareader("dc_operasi_bersih_hasil")
                    End If

                    'jika bulan 2,5,8,11 
                    If objdatareader("in_bulan") = 2 Or objdatareader("in_bulan") = 5 Or objdatareader("in_bulan") = 8 Or objdatareader("in_bulan") = 11 Then
                        dthasil.Rows(j).Item("lama2") = objdatareader("in_lama_bersih")
                        dthasil.Rows(j).Item("JUMLAH2") = Val(dthasil.Rows(j).Item("JUMLAH2")) + objdatareader("dc_operasi_bersih_hasil")
                    End If

                    'jika bulan 3,6,9,12 
                    If objdatareader("in_bulan") = 3 Or objdatareader("in_bulan") = 6 Or objdatareader("in_bulan") = 9 Or objdatareader("in_bulan") = 12 Then
                        dthasil.Rows(j).Item("lama3") = objdatareader("in_lama_bersih")
                        dthasil.Rows(j).Item("JUMLAH3") = Val(dthasil.Rows(j).Item("JUMLAH3")) + objdatareader("dc_operasi_bersih_hasil")
                    End If

                End If
                If dthasil.Rows(j).Item("kode") = "0005" Then    'bt
                    'jika bulan 1,4,7,10 
                    If objdatareader("in_bulan") = 1 Or objdatareader("in_bulan") = 4 Or objdatareader("in_bulan") = 7 Or objdatareader("in_bulan") = 10 Then
                        dthasil.Rows(j).Item("lama1") = objdatareader("in_lama_bt")
                        dthasil.Rows(j).Item("JUMLAH1") = Val(dthasil.Rows(j).Item("JUMLAH1")) + objdatareader("dc_operasi_bt_hasil")
                    End If

                    'jika bulan 2,5,8,11 
                    If objdatareader("in_bulan") = 2 Or objdatareader("in_bulan") = 5 Or objdatareader("in_bulan") = 8 Or objdatareader("in_bulan") = 11 Then
                        dthasil.Rows(j).Item("lama2") = objdatareader("in_lama_bt")
                        dthasil.Rows(j).Item("JUMLAH2") = Val(dthasil.Rows(j).Item("JUMLAH2")) + objdatareader("dc_operasi_bt_hasil")
                    End If

                    'jika bulan 3,6,9,12 
                    If objdatareader("in_bulan") = 3 Or objdatareader("in_bulan") = 6 Or objdatareader("in_bulan") = 9 Or objdatareader("in_bulan") = 12 Then
                        dthasil.Rows(j).Item("lama3") = objdatareader("in_lama_bt")
                        dthasil.Rows(j).Item("JUMLAH3") = Val(dthasil.Rows(j).Item("JUMLAH3")) + objdatareader("dc_operasi_bt_hasil")
                    End If
                End If
                If dthasil.Rows(j).Item("kode") = "0006" Then    'kotor
                    'jika bulan 1,4,7,10 
                    If objdatareader("in_bulan") = 1 Or objdatareader("in_bulan") = 4 Or objdatareader("in_bulan") = 7 Or objdatareader("in_bulan") = 10 Then
                        dthasil.Rows(j).Item("lama1") = objdatareader("in_lama_kotor")
                        dthasil.Rows(j).Item("JUMLAH1") = Val(dthasil.Rows(j).Item("JUMLAH1")) + objdatareader("dc_operasi_kotor_hasil")
                    End If

                    'jika bulan 2,5,8,11 
                    If objdatareader("in_bulan") = 2 Or objdatareader("in_bulan") = 5 Or objdatareader("in_bulan") = 8 Or objdatareader("in_bulan") = 11 Then
                        dthasil.Rows(j).Item("lama2") = objdatareader("in_lama_kotor")
                        dthasil.Rows(j).Item("JUMLAH2") = Val(dthasil.Rows(j).Item("JUMLAH2")) + objdatareader("dc_operasi_kotor_hasil")
                    End If

                    'jika bulan 3,6,9,12 
                    If objdatareader("in_bulan") = 3 Or objdatareader("in_bulan") = 6 Or objdatareader("in_bulan") = 9 Or objdatareader("in_bulan") = 12 Then
                        dthasil.Rows(j).Item("lama3") = objdatareader("in_lama_kotor")
                        dthasil.Rows(j).Item("JUMLAH3") = Val(dthasil.Rows(j).Item("JUMLAH3")) + objdatareader("dc_operasi_kotor_hasil")
                    End If
                End If
            Next
        ...
        For j = 0 To dthasil.Rows.Count - 1
            If dthasil.Rows(j).Item("JUMLAH1") <> 0 Then
                dthasil.Rows(j).Item("HASILbulan1") = Format((Val(dthasil.Rows(j).Item("JUMLAH1")) / Val(dthasil.Rows(j).Item("LAMA1"))) * 100, "standard")
            End If
            If dthasil.Rows(j).Item("JUMLAH2") <> 0 Then
                dthasil.Rows(j).Item("HASILbulan2") = Format((Val(dthasil.Rows(j).Item("JUMLAH2")) / Val(dthasil.Rows(j).Item("LAMA2"))) * 100, "standard")
            End If
            If dthasil.Rows(j).Item("JUMLAH3") <> 0 Then
                dthasil.Rows(j).Item("HASILbulan3") = Format((Val(dthasil.Rows(j).Item("JUMLAH3")) / Val(dthasil.Rows(j).Item("LAMA3"))) * 100, "standard")
            End If
        Next
