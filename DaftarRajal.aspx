<%@ Page Language="VB" MasterPageFile="~/MasterPageBlank.master" AutoEventWireup="false" CodeFile="DaftarRajal.aspx.vb" Inherits="DaftarRajal" title="Daftar Rawat Jalan" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width: 927px">
        ...
        <tr>
            ...
            <td colspan="3">
                <asp:Label ID="LblJudul" runat="server" Font-Bold="True" ForeColor="#004000" Text="DAFTAR RAWAT JALAN PASIEN"
                ...
                <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="NO.REG">
                            <ItemTemplate>
                                <asp:Label ID="lblNoReg" runat="server" Text='<%# Bind("no_reg") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Center" Width="80px" />
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="WAKTU KUNJUNGAN">
                            <ItemTemplate>
                                <asp:Label ID="lbldateKunjung" runat="server" Text='<%# Bind("tgl_kunjungan") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Center" Width="80px" />
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="KLINIK">
                            <ItemTemplate>
                                <asp:Label ID="lblKlinik" runat="server" Text='<%# Bind("nama_klinik") %>'></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="DOKTER" >
                            <ItemTemplate>
                                <asp:Label ID="lblDokter" runat="server" Text='<%# Bind("dokter") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Center" Width="80px" />
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
