<%@ Page Language="VB" MasterPageFile="~/MasterPageBlank.master" AutoEventWireup="false" CodeFile="HAIs.aspx.vb" Inherits="HAIs" title="Laporan HAIs" %>
        ...
        <tr>
            ...
            <td colspan="3">
                <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                    CellPadding="4" CssClass="mGrid" ShowFooter="True" Width="514px">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="HAIS">
                            <ItemTemplate>
                                <asp:Label ID="lblHais" runat="server" Text='<%# Bind("Hais") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" Width="280px" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="0/00">
                            <ItemTemplate>
                                <asp:Label ID="lblHasil" runat="server" Text='<%# Bind("HASIL") %>'></asp:Label>
                            </ItemTemplate>
