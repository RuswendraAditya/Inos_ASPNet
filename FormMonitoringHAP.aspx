<%@ Page Language="VB"   MasterPageFile="~/MasterPageBlank.master" AutoEventWireup="false" CodeFile="FormMonitoringHAP.aspx.vb" Inherits="FormMonitoringHAP" %>
    ...
    <table style="width: 632px; height: 200px;" border="1" >
     <tr>
            ...
            <td colspan="5" style="font-weight: bold; font-size: 11pt; color: blue; height: 25px; width: 150px; text-align: center;">
                ...
                PELAKSAAAN BUNDLE PENCEGAHAN HAP</td>
        </tr>
    </table>
    &nbsp; &nbsp;&nbsp;<br />
    <br />
         ...
         CssClass="mGrid" Height="30px" ShowFooter="True" Width="150px" Font-Size="8pt" Font-Italic="True" >  
            <Columns>  
              ...
              <asp:TemplateField HeaderText="VC kode" visible =false >  
                ...
                <asp:TemplateField HeaderText="Pencegahan HAP" >  
                    <ItemTemplate >  
            ...
            <Columns>   
             <asp:TemplateField HeaderText="Monitoring" visible=false>  
              ...
              <asp:TemplateField HeaderText="VC kode" visible=false>  
                ...
                <asp:TemplateField HeaderText="Diagnosa HAP">  
                    <ItemTemplate>  
                        <asp:Label ID="lbl_nama" runat="server" Width="150px"   Text='<%# Eval("vc_nama") %>'></asp:Label>  
                    </ItemTemplate>  
                </asp:TemplateField>  
    ...
    <table style="width: 732px; height: 100px;" border="1" >
        <tr>
            <td style="width: 150px; height: 16px;">
                Kejadian Infeksi Rumah Sakit(HAP)</td>
            <td style="width: 341px; height: 16px;"><asp:CheckBox ID="ChkBoxInfeksiHAPYa" runat="server" Text="Ya" TextAlign="Left" />
                <asp:CheckBox ID="ChkBoxInfeksiHAPTidak" runat="server" Text="Tidak" TextAlign="Left" /></td>
        </tr>
    </table>
                <br /><br />
               <div align="center">
         <asp:Button ID="BtnSaveMonitoringHAP"   runat="server" Text="Save" Height="48px" Width="128px" BackColor="CornflowerBlue" />
