<%@ Page Language="VB" MasterPageFile="~/MasterPageLogin.master" AutoEventWireup="false" CodeFile="Login.aspx.vb" Inherits="Login" title="Login..." %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    &nbsp;<div id="maincont" style="background-color: white; width: 693px;">
            ...
            <div class="midcontainer">
                <fieldset style="width: 659px; background-color: white; color: blue;">
                    <div class="container">
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td colspan="1" style="height: 4px; text-align: center">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="font-size: 13pt; width: 239px">
                                    &nbsp;SURVEILANS PPI</td>
                            </tr>
                            <tr>
                                <td style="width: 94px; color: red">
                            ...
                            <tr>
                                ...
                                <td colspan="1" style="background-color: lightslategray">
                                </td>
                            </tr>
                            <tr>
                    ...
                    <asp:Label ID="lblMsg" runat="server" CssClass="lbl" Font-Bold="True" Font-Size="Large"
                        ForeColor="Red"></asp:Label></td>
                                <td colspan="1" style="height: 5px; background-color: white; text-align: center">
                                </td>
                            </tr>
                        </table>
                    </div>
